package Objects
{
	...
	public class Project extends EventDispatcher implements IExternalizable
	{
		...
		public function toXML():XML {
			var projectNode:XML = new XML("<project />");
			projectNode.@path = path;
			projectNode.@project = project;
			projectNode.@job = job;
			projectNode.@client_name = client_name;
			projectNode.@client_address = client_address;
			projectNode.@integrator = integrator;
			projectNode.@company = company;
			projectNode.@company_address = company_address;
			projectNode.@phone = phone;
			projectNode.@fax = fax;
			projectNode.@mobile = mobile;
		 	projectNode.@email = email;
			projectNode.@notes = notes;
			return projectNode;
		}
	}
}