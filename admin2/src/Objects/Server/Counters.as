package Objects.Server {
	...
	import Forms.Server.Counters_frm;
	[Bindable("counters")]
	...
	public class Counters extends BaseElement {
		...
		public override function readExternal(input:IDataInput):void {
			...
			counters = input.readObject()as ArrayCollection;
		}
		...
		public function getClassForm():Class {
			var className:Class = Forms.Server.Counters_frm;
			return className;		
		}
		...
		public  function get Data():ObjectProxy {
			var ob:ObjectProxy = new ObjectProxy( {counters:counters, dataObject:this})
			return ob;
		}
		[Bindable]
