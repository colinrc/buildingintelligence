package Objects.Server {
	...
	import Forms.Server.DynaliteLights_frm;
	import mx.collections.ArrayCollection;
	[Bindable("DynaliteLights")]
	[RemoteClass(alias="elifeAdmin.server.dynaliteLights")] 
	public class DynaliteLights extends BaseElement {
		[Bindable]
		...
		public function getClassForm():Class {
			var className:Class = Forms.Server.DynaliteLights_frm;
			return className;		
		}
		public override function toXML():XML {
			...
			for (var light in lights) {
				var newLight = new XML("<LIGHT_DYNALITE />");
