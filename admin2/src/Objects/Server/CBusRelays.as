package Objects.Server {
	...
	import Forms.Server.CBusRelays_frm;
	...
	public class CBusRelays extends BaseElement {
		...
		[Bindable]
		public var relays:ArrayCollection;
		...
		public override function readExternal(input:IDataInput):void {
			...
			relays = input.readObject()as ArrayCollection;
		}
		...
		public function getClassForm():Class {
			var className:Class = Forms.Server.CBusRelays_frm;
			return className;		
		}
		...
		public  function get Data():ObjectProxy {
			var ob:ObjectProxy = new ObjectProxy({relays:relays, dataObject:this});
			return ob;
		}
