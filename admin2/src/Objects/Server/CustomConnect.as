package Objects.Server {
	...
	public class CustomConnect extends Device {
		...
		public override function toXML():XML {
			...
			for(var child in tempCustomKeys.children()){
				newCustomConnection.appendChild(tempCustomKeys.children()[child]);
			}
			var tempInStrings = inStrings.toXML();
			for(var child in tempInStrings.children()){
				newCustomConnection.appendChild(tempInStrings.children()[child]);
			}
			var tempOutStrings = outStrings.toXML();
			for(var child in tempOutStrings.children()){
				newCustomConnection.appendChild(tempOutStrings.children()[child]);
			}
