 ...
 * 
 */
public class GenreCommand implements CommandInterface {
	...
	public GenreCommand(String key, String commandCode, User user) {
		creationDate = System.currentTimeMillis();
		setKey(key);
	...
	public Element getXMLCommand() {
		Element element = new Element("genres");

		LinkedList albumElements = new LinkedList();
		
		for (Genre Genre: genres) {
			albumElements.add(Genre.getElement());
		}
