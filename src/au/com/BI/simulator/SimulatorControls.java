...
public class SimulatorControls extends JFrame implements ActionListener, SerialCommsObject {
	...
	private JButton wheelButtonBlue;
	private JButton wheelButtonYellow;
	...
	public SimulatorControls(SimulatorWindow simulator) {
		...
		wheelButtonBlue = new JButton("Wheel Button Blue");
		wheelButtonBlue.setActionCommand("iwheelButtonBlue");
		wheelButtonBlue.addActionListener(this);
		wheelButtonYellow = new JButton("Wheel Button Yellow");
		wheelButtonYellow.setActionCommand("iwheelButtonYellow");
		wheelButtonYellow.addActionListener(this);
		...
		incoming.add(wheelButtonBlue,c);
		incoming.add(wheelButtonYellow,c);
		c.gridwidth = GridBagConstraints.REMAINDER;
