package Objects.Server {
	...
	public class GC100 extends Device {
		...
		[Bindable]
		public var irs:GC100IRs;
		[Bindable]
		public var toggle_inputs:GC100Toggles;
		[Bindable]
		public var toggle_outputs:GC100Toggles;	
		...
		public override function newObject():void {
			...
			toggle_outputs.setToggleType("TOGGLE_OUTPUT");
		...
		public override function setXML(newData:XML):void {
			...
			toggle_outputs = new Objects.Server.GC100Toggles();
			toggle_outputs.setToggleType("TOGGLE_OUTPUT");
			var tempModules:ArrayCollection = new ArrayCollection();
			var tempIRs:ArrayCollection = new ArrayCollection();
			var tempToggle_Inputs:ArrayCollection = new ArrayCollection();
			var tempToggle_Outputs:ArrayCollection = new ArrayCollection();
			if (newData.name() == "DEVICE") {
				...
				for (var child:int=0 ; child < newData.children().length() ; child++) {
					...
					case "GC100_Relay":
						...
						for (var index:int=0 ; index < tempNode.children().length() ; index++) {
							var fName:String = tempNode.children()[index].name();
							switch(fName){
								case "IR":
								...
								case "TOGGLE_OUTPUT":
									...
									tempToggle_Outputs.addItem(newToggle);
									break;							
								case "TOGGLE_INPUT":
									var newToggle = new Object();
									...
									tempToggle_Inputs.addItem(newToggle);
									break;
							}
						}
						tempModules.addItem(newModule);
						break;
					}
				}
				/*
				...
				*/
				modules.modules = tempModules;
				Application.application.moduleNumber = modules.getModuleNumbers();
				irs.irs = tempIRs;
					irs.modules = modules;
				toggle_inputs.toggles = tempToggle_Inputs;
					toggle_inputs.modules = modules;
				toggle_outputs.toggles = tempToggle_Outputs;
					toggle_outputs.modules = modules;
