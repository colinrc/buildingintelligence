package Objects.Server {
	...
	import Forms.Server.CBusTemperatureSensors_frm;
	...
	public class CBusTemperatureSensors extends BaseElement {
		...
		public function getClassForm():Class {
			var className:Class = Forms.Server.CBusTemperatureSensors_frm;
			return className;		
		}
		...
		public  function get Data():ObjectProxy {
			var ob:ObjectProxy = ObjectProxy( {sensors:sensors, dataObject:this});
			return ob;
		}
