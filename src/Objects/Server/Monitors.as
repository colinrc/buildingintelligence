package Objects.Server {
	...
	import Forms.Server.Monitors_frm;
	...
	public class Monitors extends BaseElement {
		...
		[Bindable]
		public var monitors:ArrayCollection;
		...
		public override function readExternal(input:IDataInput):void {
			...
			monitors = input.readObject()as ArrayCollection;
		}
		...
		public function getClassForm():Class {
			var className:Class = Forms.Server.Monitors_frm;
			return className;		
		}
		...
		public  function get Data():ObjectProxy {
			var ob:ObjectProxy = new ObjectProxy({monitors:monitors, dataObject:this});
			return ob;
		}
		[Bindable]
