...
class Forms.DataGrid.KeyBoxCellRenderer extends UIComponent {
	var label:MovieClip;
	...
	// the function we receive from the list
	var tabForm:MovieClip;
	function KeyBoxCellRenderer() {
	}
