    ...
    //        ta1.text+="\ntarget data: " + event.target.dataProvider.@data;
			...
			switch(event.label) {
			    ...
			    case "Open Project":
			     ...
			     // var pop1:IFlexDisplayObject = PopUpManager.createPopUp(this, ProjectDialog,true);
					...
					{		
						var f1Str:String = File.appResourceDirectory.nativePath + "\\projects";			
						var f1:File = File.appResourceDirectory.resolve(f1Str);
					    fileOpenPanel = FileOpenPanel.show(f1);
					}
			    ...
			    case "Save Project":
			      ...
			      if (projectFileName) 
					...
					{		
						var f1Str:String = File.appResourceDirectory.nativePath + "\\projects\\"+project.name;			
						var f1:File = File.appResourceDirectory.resolve(f1Str);
        ...
        */
        ...
        public function setPath():void  {
			var f1Str:String = File.appResourceDirectory.nativePath + "\\projects\\"+project.project;			
			var f1:File = File.appResourceDirectory.resolve(f1Str);
			if (f1.exists == false) {
				f1.createDirectory();
				f1 = File.appResourceDirectory.resolve(f1Str + "\\server");	
				f1.createDirectory();
				f1 = File.appResourceDirectory.resolve(f1Str + "\\server\\config");	
				f1.createDirectory();
				f1 = File.appResourceDirectory.resolve(f1Str + "\\server\\datafiles");	
				f1.createDirectory();
				f1 = File.appResourceDirectory.resolve(f1Str + "\\server\\script");	
				f1.createDirectory();
				f1 = File.appResourceDirectory.resolve(f1Str + "\\client");	
				f1.createDirectory();
				f1 = File.appResourceDirectory.resolve(f1Str + "\\client\\lib");	
				f1.createDirectory();
				f1 = File.appResourceDirectory.resolve(f1Str + "\\client\\lib\\icons");	
				f1.createDirectory();
				f1 = File.appResourceDirectory.resolve(f1Str + "\\client\\lib\\maps");	
				f1.createDirectory();
				f1 = File.appResourceDirectory.resolve(f1Str + "\\client\\lib\\backgrounds");	
				f1.createDirectory();
				f1 = File.appResourceDirectory.resolve(f1Str + "\\client\\lib\\sounds");	
				f1.createDirectory();
				f1 = File.appResourceDirectory.resolve(f1Str + "\\client\\lib\\objects");	
				f1.createDirectory();
				unsaved = true;
			}
		...
		if (projectFileName.exists) {
			//var newProjectXML:XML = new XML("<project />");
			//for (var attrib:int in project_xml) {
		...
		//	newProjectXML.appendChild(serverInstance.toXML());
			...
			fileSave.saveProjectFile(projectFileName, project_xml.toString());
