class Objects.Server.Jandy extends Objects.Server.Device {
	...
	private var outputs:Objects.Server.Toggles;
	private var sensors:Objects.Server.Toggles;
	...
	public function toXML():XMLNode {
		...
		for (var child in tempSensors.childNodes) {
			newJandy.appendChild(tempSensors.childNodes[child]);
		}
		...
		if (newData.nodeName == "DEVICE") {
			...
			for (var child in newData.childNodes) {
				...
				case "JANDI" :
					...
					switch (tempNode.childNodes[JandyDevice].nodeName) {
						case "OUTPUT":
							tempOutputs.appendChild(tempNode.childNodes[JandyDevice]);
							break;
						case "SENSOR":
							tempSensors.appendChild(tempNode.childNodes[JandyDevice]);
							break;
						}
					}
