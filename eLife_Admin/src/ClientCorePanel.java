...
public class ClientCorePanel extends JPanel
{
	...
	public ClientCorePanel(eLife_Admin eLife)
	{
		this.eLife = eLife;
		...
		list.addActionListener(
			new ActionListener() {
				public void actionPerformed(ActionEvent evt) {
					ClientCorePanel.this.eLife.readFiles("client-core");
				}
			});
		...
		download.addActionListener(
			new ActionListener() {
				public void actionPerformed(ActionEvent evt) {
					...
					if (sel <= numElements) {
						ClientCorePanel.this.eLife.downloadFile("client-core",(String)files[sel]);
					}
				}
			});
				...
				new ActionListener() {
					public void actionPerformed(ActionEvent evt) {
						...
						if (sel <= numElements && confirmed) {
							clearConfirm();
							ClientCorePanel.this.eLife.deleteFile("client-core",(String)files[sel]);
						}
					}
				});
