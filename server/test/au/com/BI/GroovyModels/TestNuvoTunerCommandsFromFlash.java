...
public class TestNuvoTunerCommandsFromFlash extends TestCase {
	...
	protected void setUp() throws Exception {
		...
		audioFrontRoom = new Audio ("Lounge Room AC Zone",DeviceType.AUDIO);
		audioFrontRoom.setKey("01");
		audioFrontRoom.setOutputKey("LOUNGE_AIR");

		kitchenAudio = new Audio ("Kitchen AC Zone",DeviceType.AUDIO);
		kitchenAudio.setKey("02");
		kitchenAudio.setOutputKey("KITCHEN_AIR");
