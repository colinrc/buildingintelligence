 ...
 * 
 */
public class AlbumCommand implements CommandInterface {
	...
	public CommandInterface clone() throws CloneNotSupportedException {
		...
		try {
			...
			newCopy.setAlbums((LinkedList<Album>)albums.clone());
			return newCopy;
	...
	public AlbumCommand(String key, String commandCode, User user) {
		creationDate = System.currentTimeMillis();
		setKey(key);
	...
	public Element getXMLCommand() {
		Element element = new Element("albums");

		LinkedList albumElements = new LinkedList();
		
		for (Album album: albums) {
			albumElements.add(album.getElement());
		}
