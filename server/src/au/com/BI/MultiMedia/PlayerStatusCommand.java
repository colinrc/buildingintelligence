 ...
 * 
 */
public class PlayerStatusCommand implements CommandInterface {

	public String key = "";
	protected PlayerStatusReply playerstatus;
	...
	public PlayerStatusCommand(String key, String commandCode, User user) {
		creationDate = System.currentTimeMillis();
		setKey(key);
	...
	public Element getXMLCommand() {
		return playerstatus.getElement();
	}
	...
	public PlayerStatusReply getPlayerstatus() {
		return playerstatus;
	}

	public void setPlayerstatus(PlayerStatusReply playerstatus) {
