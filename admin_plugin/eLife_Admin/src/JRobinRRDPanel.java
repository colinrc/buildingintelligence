...
public class JRobinRRDPanel extends JPanel
{
	...
	public JRobinRRDPanel(eLife_Admin eLife)
	{
		this.eLife = eLife;
		...
		list.addActionListener(
			new ActionListener() {
				public void actionPerformed(ActionEvent evt) {
					JRobinRRDPanel.this.eLife.readFiles("server/JRobin/RRDDefinition");
				}
			});
		...
		download.addActionListener(
			new ActionListener() {
				public void actionPerformed(ActionEvent evt) {
					...
					if (sel <= numElements) {
						JRobinRRDPanel.this.eLife.downloadFile("server/JRobin/RRDDefinition",(String)configs[sel]);
					}
				}
			});
				...
				new ActionListener() {
					public void actionPerformed(ActionEvent evt) {
						...
						if (sel <= numElements && confirmed) {
							clearConfirm();
							JRobinRRDPanel.this.eLife.deleteFile("server/JRobin/RRDDefinition",(String)configs[sel]);
						}
					}
				});
