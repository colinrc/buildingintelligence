class Objects.ServerInstances{
	...
	public function toXML():XMLNode {
		var serversNode = new XMLNode(1, "serverInstances");
	...
	public function setXML(newData:XMLNode):Void {
		...
		if (newData.nodeName == "serverInstances") {
			...
			trace("ERROR, found node "+newData.nodeName+", expecting serverInstances");
		}
	}
