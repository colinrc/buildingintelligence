...
class Forms.Project.Device.CbusLights {
	...
	public function init() {
		for (var light in lights) {
			lights_dg.addItem({name:lights[light].attributes["NAME"], display_name:lights[light].attributes["DISPLAY_NAME"], key:lights[light].attributes["KEY"], active:lights[light].attributes["ACTIVE"], area:lights[light].attributes["AREA"], power:lights[light].attributes["POWER_RATING"], relay:lights[light].attributes["RELAY"], application:lights[light].attributes["CBUS_APPLICATION"]});
		}
