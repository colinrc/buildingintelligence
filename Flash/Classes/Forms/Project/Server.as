...
class Forms.Project.Server extends Forms.BaseForm {
	...
	public function onLoad() {
		...
		var newArray = [{label:"COMFORT"},{label:"CUSTOM_CONNECT"}, {label:"DMX"}, {label:"IR_LEARNER"}, {label:"PELCO"}, {label:"GC100"}, {label:"TUTONDO"}, {label:"DYNALITE"},  {label:"RAW_CONNECTION"}, {label:"HAL"}, {label:"OREGON"}, {label:"KRAMER"}, {label:"CBUS"},{label:"NUVO"},{label:"SIGN_VIDEO"},{label:"M1"}]
